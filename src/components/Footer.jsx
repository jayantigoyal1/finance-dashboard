    ...
    <footer className="border-t border-border bg-surface px-6 py-4">
      <div className="mx-auto flex max-w-[1400px] items-center justify-between">
        ...
        <div className="flex items-center gap-2 font-mono text-[11px] text-text3">
          <span>Built By</span>
          <span className="font-semibold text-text2">Jayanti Goyal</span>
        </div>

        {/* Right Side (GitHub Link) */}
        <a
          href="https://github.com/jayantigoyal1"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 rounded-lg border border-border px-3 py-1.5
            font-mono text-[11px] text-text2 transition-all duration-200
